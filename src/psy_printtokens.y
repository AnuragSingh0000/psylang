...
%token AND DOUBLE_AND PIPE DOUBLE_PIPE TILDE XOR // bitwise operators
%token SHIFT_LEFT SHIFT_RIGHT // bitshift operators 
%token EQ PLUS_EQ MINUS_EQ STAR_EQ SLASH_EQ PERC_EQ PLUS_PLUS MINUS_MINUS // assignment operators
...
%token FUN RET ARROW LAMBDA // for functions
...
token:
    ...
    | STAR_EQ          { printf("STAR_EQ\n"); }
    | SLASH_EQ          { printf("SLASH_EQ\n"); }
    | PERC_EQ          { printf("PERC_EQ\n"); }
